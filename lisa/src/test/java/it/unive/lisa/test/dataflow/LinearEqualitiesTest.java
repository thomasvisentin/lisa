...
public class LinearEqualitiesTest {
	...
	public void testLinearEqualities() throws ParsingException, AnalysisException {
		...
		ValueDomain<?> valueDomain = new PossibleForwardDataflowDomain<>(new LinearEqualities());
		...
		lisa.setWorkdir("test-outputs/linear-equalities");
		...
		Program impProgram = IMPFrontend.processFile("Linear-equalities.imp");
